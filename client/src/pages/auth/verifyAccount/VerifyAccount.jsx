      ...
      {success || user?.isVerified ? (
        ...
        <div className="bg-white p-4 rounded-xl shadow w-full max-w-[400px]">
          ...
          >
            <RiMailFill
              size={40}
              className="text-green-500 p-2 border-[0.2px] border-green-500 rounded-full shadow-lg"
            />
            ...
            <div className="my-4 w-full md:w-[350px] text-center">
              ...
              <PinField
                ...
                className="w-[50px] sm:w-[58px] text-center border text-green-500 border-gray-300 rounded-md p-2 font-bold my-2"
              />
            </div>
            <button
              type="submit"
              className="py-2 rounded-md bg-(--primary-color) hover:bg-(--secondary-color) text-white w-full md:w-[350px] cursor-pointer"
          ...
          <div>
            ...
            >
              ...
              <button
                className={`p-3 rounded-md bg-green-500 hover:bg-green-600 cursor-pointer ${
                  isResendDisabled
