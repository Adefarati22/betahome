export const welcomeUserTemplate = (
  ...
  <head>
      <style>
          ...
          .header { background-color:rgba(61, 153, 112, 1); color: white; padding: 20px; text-align: center; }
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              ${
                password
                  ? `<p style="font-weight: bold; font-size: 20px; color:rgba(61, 153, 112, 1);">Your password is ${password}. Please update your password in the settings as soon as possible.</p>`
                  : ""
              }
              <p style="font-weight: bold; font-size: 20px; color:rgba(61, 153, 112, 1);">${verificationCode}</p>
              <p>This code will expire in 1 hour.</p> 
              <p>Do not share this code with anyone.</p>    
          </div>
          <div class="footer">
              <p>© ${new Date().getFullYear()} BetaHouse. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>`;
